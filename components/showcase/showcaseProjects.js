/**
 * Single source of truth for showcase: 15 projects used by both cards and circles.
...
export const PROJECTS = [
  ...
  { label: 'Job Tracking', typeKey: 'showcase_type_system', titleKey: 'showcase_card_job_tracking', url: 'https://mustafa-network-tech.github.io/pro-track/', descKey: 'showcase_card_desc_job_tracking' },
  ...
  { label: 'Mavi Kadraj', typeKey: 'showcase_type_website', titleKey: 'showcase_card_mavi_kadraj', url: 'https://mavikadraj.com.tr', descKey: 'showcase_card_desc_mavi_kadraj' },
...
export const SECTIONS = [
  { sectionId: 'showcase-section-platforms', titleKey: 'showcase_section_platforms_title', descKey: 'showcase_section_platforms_desc', icon: '⚙', cardTitles: ['MK Digital Systems', 'MK Ops', 'Job Tracking', 'ARIA'] },
