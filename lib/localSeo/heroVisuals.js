...
export const HERO_TYPEWRITER_BY_SLUG = {
  ...
  'izmit-web-tasarim': [
    'İzmit işletmeleri için hizmet sunumu',
    'Hizmetten iletişime açık bir yol',
  ...
  'bartin-mobil-uyumlu-web-sitesi': [
    'Mevcut sitenizde mobil kullanım',
    'Dokunmatik dostu menü ve form',
    'Menü, galeri ve form kontrolü',
  ],
  ...
  'karabuk-web-tasarim': [
    'Karabük işletmeleri için web tasarım',
    'Menü, hizmet ve konum bilgisi',
    'İşletmenize uygun sayfa kapsamı',
  ],
  'bilecik-web-tasarim': [
