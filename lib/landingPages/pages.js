...
const SERVICE_PAGES = [
  ...
  },
  {
    ...
    projects: ['santiye-yonetim-sistemi', 'mk-farm', 'mk-traceops', 'mk-pati', 'mk-ops', 'mavi-resepsiyon', 'mavi-adisyon'],
    detailProjects: ['santiye-yonetim-sistemi', 'mk-farm', 'mk-traceops', 'mk-pati', 'mk-ops', 'mavi-resepsiyon', 'mavi-adisyon'],
    ...
    faqs: [
      ...
      ['Bütün örnekler canlı müşteri kurulumu mu?', 'Hayır. Şantiye projesi ve MK Farm aktif kullanımda, MK TraceOps geliştirme aşamasında, MK Pati yayında, resepsiyon ve adisyon çalışmaları ise demo olarak kayıtlıdır. Her kart merkezi proje verisindeki güncel durumu gösterir.'],
...
export const PROJECT_PROBLEMS = {
  ...
  'mk-pati': 'Hasta geçmişi, aşı takvimi ve randevuların klinikte farklı yerlerde tutulması.',
