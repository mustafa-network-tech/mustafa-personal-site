...
const SERVICE_PAGES = [
  ...
  },
  {
    ...
    sections: [
      ...
      ['Hizmetten iletişime giden yolu kısaltın', 'Gayrimenkul, cafe ve kurumsal site demoları farklı içerik düzenlerini görmenizi sağlar. Gerçek işletme bilgileriniz ve iletişim kanallarınız proje kapsamına göre yerleştirilir.'],
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      ['Kurumsal ve hizmet işletmeleri', 'Mavi İletişim ve Mavi Danışmanlık demoları, hizmetlerin sınıflandırılması ve talep oluşturma için örnekler sunar. Marka metinleri ve gerçek işletme bilgileri size özel hazırlanır.'],
    ],
    ...
    faqs: [
      ['Osmaniye’deki işletmem için görüşme uzaktan yapılabilir mi?', 'Evet. İçerik, tasarım ve proje kapsamı çevrim içi görüşmelerle ele alınabilir. Bu sayfa Osmaniye’de fiziksel ofis bulunduğu iddiası taşımaz.'],
  ...
  },
  {
    ...
    title: 'Osmaniye Cafe ve Kurumsal Web Sitesi | Menü ve Hizmetler',
    description: 'Osmaniye cafe, restoran ve kurumsal işletmeleri için menü, galeri, hizmet ve iletişim akışları. Mavi Kafe ile kurumsal portföy demolarını keşfedin.',
    h1: 'Osmaniye’de menünüzü veya hizmetlerinizi doğru sunun',
    intro: 'Bir restoranda ziyaretçi menüyü inceleyip konuma bakar; kurumsal hizmette ise ne yaptığınızı anlayıp görüşme talep eder. İki farklı ihtiyacı aynı tasarım kalıbına sıkıştırmadan, işletmenize uygun bir içerik akışı oluşturuyoruz.',
    needTitle: 'İletişimden önce cevaplanması gereken sorular',
    need: 'Ne sunuyorsunuz, hangi saatlerde açıksınız, hizmetiniz kimlere uygun ve ziyaretçi sonraki adımda ne yapmalı? İçerik hazırlığı bu sorularla başlar. Formlar ve çağrı butonları bilgiyi tamamlayan adımlardır.',
    solutionTitle: 'Mekân deneyimi ve kurumsal anlatım için farklı yollar',
    sections: [
      ['Cafe ve restoran: menüye öncelik', 'Mavi Kafe & Restaurant demosundaki dijital menü, kategori, galeri ve açılış saati alanları bir örnek sunar. Mobilde menüye erişim ve konum/iletişim adımları öncelikli değerlendirilir.'],
      ['Kurumsal site: kapsamı netleştirin', 'Hizmet sayfaları, işletme anlatımı ve iletişim alanı karar vermeyi destekler. Kurumsal demoların içerik düzeni incelenir; gerçek olmayan müşteri, referans veya başarı verisi kullanılmaz.'],
      ['Web sitesinin ötesinde operasyon', 'Rezervasyon formu tanıtım sitesinin bir parçası olabilir. Masa, sipariş ve kasa takibi ise Mavi Adisyon gibi ayrı bir yazılım kapsamıdır; bu ayrımı baştan yaparız.'],
    ],
    projects: ['mavi-kafe', 'mavi-iletisim', 'mavi-danismanlik', 'mavi-adisyon'], detailProjects: ['mavi-kafe', 'mavi-iletisim', 'mavi-danismanlik', 'mavi-adisyon'],
    projectTitle: 'Tanıtım ve operasyon farkını örneklerde görün',
    process: ['Menü veya hizmet listesini, görselleri ve iletişim kanallarını belirleriz.', 'Mobil içerik sırası ve talep/rezervasyon adımlarını tasarlarız.', 'Formların kapsamını, içerik güncellemelerini ve yayın kontrollerini netleştiririz.'],
    faqs: [
      ['Cafe sitesine adisyon sistemi dahil mi?', 'Tanıtım sitesi ile adisyon yazılımı ayrı kapsamlardır. Mavi Kafe web sitesi örneği, Mavi Adisyon ise masa, sipariş ve kasa süreçlerini gösteren portföy demosudur.'],
      ...
      ['Kurumsal sitemizde cafe demosunun yapısı mı kullanılacak?', 'Hayır. Cafe için menü ve mekân, kurumsal site için hizmet kapsamı ve talep akışı önceliklidir. Sayfa düzeni işletmenizin içerik ihtiyacına göre hazırlanır.'],
    ],
    related: ['osmaniye-web-tasarim', 'ozel-yazilim-gelistirme'], cta: 'Menünüzü ve Hizmetlerinizi Konuşalım', projectsFirst: true,
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      ['Şehir sayfaları farklı yazılımlar mı sunuyor?', 'Hayır. Aynı gerçek projeyi farklı kullanım ihtiyaçları üzerinden açıklar. Bölgesel sayfalar, yerel müşteri kurulumu veya fiziksel ofis iddiası içermez.'],
    ],
